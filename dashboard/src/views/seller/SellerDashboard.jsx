...
const SellerDashboard = () => {
    const state = {
        series: [
            {
                name: "Orders",
                data: [23, 34, 45, 56, 76, 34, 23, 76, 78, 88, 78, 80]
            },
            {
                name: "Revenue",
                data: [67, 39, 45, 56, 90, 34, 23, 76, 78, 88, 89, 90]
            },
            {
                name: "Sales",
                data: [34, 39, 56, 56, 80, 34, 23, 76, 99, 90, 98, 88]
            },
        ],
        options: {
            color: ['#181ee8', '#181ee8'],
        ...
        <div className='px-2 md:px-7 py-5'>
            ...
            md:grid-cols-2 lg:grid-cols-4 gap-7'>
                ...
                rounded-md gap-3'>
                    ...
                    <div className='w-[40px] h-[47px] rounded-full bg-[#fa0305] flex justify-center 
                ...
                rounded-md gap-3'>
                    ...
                    <div className='w-[40px] h-[47px] rounded-full bg-[#760077] flex justify-center 
                    items-center text-xl'>
                ...
                rounded-md gap-3'>
                    ...
                    <div className='w-[40px] h-[47px] rounded-full bg-[#0200f8] flex justify-center 
                    items-center text-xl'>
                        <FaCartShopping className='text-[#fae8e8] shadow-lg' />
                    </div>
                </div>
                        ...
                        <div className='flex flex-col gap-2 pt-6 text-[#d0d2d6]'>
                            <ol className='relative border-1 border-slate-600 ml-4'>
                                <li className='mb-3 ml-6'>
                                    ...
                                    justify-center items-center w-10 h-10 p-[6px] bg-[#4c7fe2] rounded-full z-10'>

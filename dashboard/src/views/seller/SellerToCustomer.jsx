                ...
                <div className='flex w-full h-full relative'>
                    ...
                    ${show 
                        ...
                        <div className='w-full h-[calc(100vh-177px)] bg-[#9e97e9] md:bg-transparent overflow-y-auto'>
                            ...
                            <div className={`h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer`}>
                                ...
                                <div className='flex justify-between items-start flex-col w-full'>
                                    <div className='flex justify-between items-center w-full'>
                                        <h2 className='text-base font-semibold'>Tommy</h2>
                                    </div>
                                </div>
                            </div>
                            <div className={`h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer`}>
                                ...
                                <div className='flex justify-between items-start flex-col w-full'>
                                    <div className='flex justify-between items-center w-full'>
                                        <h2 className='text-base font-semibold'>Peter</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
                        <div className='flex justify-between items-center'>
                            {
                                sellerId && <div className='flex gap-3 items-center justify-start'> 
                                    <div className='relative'>
                                    ...
                                    <h2 className='text-base text-white font-semibold'>James</h2>
                                </div>
                            }
                            ...
                            <div className='bg-[#475569] h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto'>
                                <div className='w-full flex justify-start items-center'>
                                    <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                                        <div>
                                            <img className='w-[38px] h-[38px] border-white border-2 max-w-[38px] p-[3px] rounded-full' src="http://localhost:3000/images/demo.jpg" alt="" />
                                        </div>
                        ...
                        <form className='flex gap-3'>
                            ...
                            <button className='shadow-lg bg-[#06b6d4] hover:shadow-cyan-500/50 w-[75px] h-[35px] rounded-md text-white flex-justify items-center items-center'>Send</button>
                        </form>
                    </div>
                </div>
            </div>
